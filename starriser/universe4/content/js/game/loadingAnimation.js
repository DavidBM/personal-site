var LoadingAnimation = function (fadeInTime) {
	this.init(fadeInTime);
};

LoadingAnimation.prototype.init = function(fadeInTime) {
...
LoadingAnimation.prototype.setCanvasSize = function(positionX, positionY) {
	this.position.x = positionX / 2 - this.textCanvas.width / 2 - 5;
	this.position.y = positionY / 2 - 25;
};
