...
SolarSystem.prototype.drawPlanet = function(i, ctx) {
	...
	positionJ = positionJ - positionI;
	if(positionJ < 0) positionJ = 1;
	if(positionI == 0) positionI = 2;
...
SolarSystem.prototype.startAutoZoom = function(node, initialZoom, finalZoom, duration, desX, desY, initialAlpha, finalAlpha, funct, functMode, finishFunction, followPlanet, semiTransparentBackground) {
	...
	if(this.animationData.planetOnZoom === null) this.animationData.planetOnZoom = {x: -15000, y: -2000};
	else if(!Utils.isObject(this.animationData.planetOnZoom)) this.animationData.planetOnZoom = {x: this.nodes[this.animationData.planetOnZoom].x, y: this.nodes[this.animationData.planetOnZoom].y};
};
...
SolarSystem.prototype.autoZoom = function() {
	...
	animationCenter = this.animationData.planetOnZoom;
