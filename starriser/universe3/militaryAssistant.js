...
MilitaryAssistant.prototype.init = function() {
	...
	this.data.movements.ETAs = [];

	this.tabs = new MinTabs();
	this.tabs.addTab("Movimientos de tropas", [
		createElement("div").setClass("militaryAssistant historyContainer").saveIn(this.dom.movements, "container").addChild(createElement("div").setClass("loading").saveIn(this.dom.movements, "loading")),
		createElement("div").setClass("clear")
	]);
	this.tabs.addTab("Tropas estacionadas", [
		createElement("div").setClass("militaryAssistant stationedContainer").saveIn(this.dom.stationed, "container").addChild(createElement("div").setClass("loading").saveIn(this.dom.stationed, "loading")),
		createElement("div").setClass("clear")
	]);
...
MilitaryAssistant.prototype.createHistoryMovement = function() {
	...
	for (var i = 0; i < data.length; i++) {
		d = data[i];
		c[i] = createElement("div").setClass("militaryAssistant shipTravelCard " + d.type)
...
MilitaryAssistant.prototype.createHistoryStationed = function() {
	...
	for (var i = 0; i < data.length; i++) {
		d = data[i];
		c[i] = createElement("div").setClass("militaryAssistant shipStationedCard " + d.type)
...
MilitaryAssistant.prototype.updateMovementsTimes = function() {
	var o = this.data.movements.ETAs;
	var len = o.length;
	for (var i = 0; i < len; i++) {
