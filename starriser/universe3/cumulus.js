...
Cumulus.prototype.autoZoom = function() {
	...
	if(this.animationData.systemOnZoom === null) animationCenter = {x: this.centerX, y: this.centerY};
	else animationCenter = {x: this.nodes[this.animationData.systemOnZoom].x, y: this.nodes[this.animationData.systemOnZoom].y};
