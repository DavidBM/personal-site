        ...
        for (const subscriberId of subscribers) {
            ...
            try {
                if (subscriberId === "main") {
                    if (priority === 0) {
                        mainBus.send_realtime("pub_message", { topic, data, senderId: workerId });
                    }
                    else if (priority === 2) {
                        mainBus.send_background("pub_message", { topic, data, senderId: workerId });
                    }
                    else {
