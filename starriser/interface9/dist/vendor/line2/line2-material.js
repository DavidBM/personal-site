...
export function applyMaterialParams(state, params) {
    if (params.color !== undefined)
        state.color.set(params.color);
    if (params.linewidth !== undefined)
        state.linewidth = params.linewidth;
    if (params.worldUnits !== undefined)
        state.worldUnits = params.worldUnits;
    if (params.dashed !== undefined)
        state.dashed = params.dashed;
    if (params.dashScale !== undefined)
        state.dashScale = params.dashScale;
    if (params.dashSize !== undefined)
        state.dashSize = params.dashSize;
    if (params.gapSize !== undefined)
        state.gapSize = params.gapSize;
    ...
    if (params.depthTest !== undefined)
        state.depthTest = params.depthTest;
    if (params.depthWrite !== undefined)
        state.depthWrite = params.depthWrite;
}
/**
...
//# sourceMappingURL=line2-material.js.map