import { createModelSelectionWorkspace, selectModelShipIndicesInto } from "./model-selection.js";
/**
...
export function selectModelShipIndices(fleets, camera, maxInstances = MODEL_LOD_MAX_INSTANCES, sticky) {
    return selectModelShipIndicesInto(createModelSelectionWorkspace(), fleets, camera, maxInstances, sticky);
}
