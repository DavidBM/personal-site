...
NodeView.prototype.drawPlanet = function(planet) {
	if(this.animationData.draw === true){
		...
		this.dom.planetBackgroundCtx.drawImage(ResourcesImg.g().get(this.images.planets), positionI * planetSize + planetSize / 2, positionJ * planetSize, planetSize / 2, planetSize, 0, 0, 53, 106);
